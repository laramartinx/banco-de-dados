...
--remover coluna 
alter table loja drop column ultima_atuaçizacao;
...
--criação de chaves estramgeiras 
alter table filme_cotegoria 
...
foreign key (invetario_id)
references inventario(inventeario_id)
